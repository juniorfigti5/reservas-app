...
class FieldsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create field" do
    assert_difference('Field.count') do
      post fields_url, params: { field: { illuminated: @field.illuminated, number: @field.number, roofed: @field.roofed, size: @field.size } }
    end
  ...
  test "should update field" do
    patch field_url(@field), params: { field: { illuminated: @field.illuminated, number: @field.number, roofed: @field.roofed, size: @field.size } }
